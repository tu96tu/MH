				...
				<div class="row">
					...
					<div class="span9">
						...
						<ul class="nav nav-tabs">
						  <li class="active">
						  	<a href="#2" data-toggle="tab">修改文章</a>
						  </li>
						</ul>
						...
						<br />
							...
							<div class="tab-content">	
								<div class="tab-pane active" id="2">
									<form method="post" action="article-modify2" id="edit-profile" class="form-horizontal" enctype="multipart/form-data">
									<fieldset>
										
										<div class="control-group">											
											<label class="control-label" for="articleTitle">文章标题</label>
											<div class="controls">
												<input type="text" class="input-medium" name="articleTitle" value="${vo.articleTitle }" />
										...
										<div class="control-group">											
											...
											<div class="controls">
												<input type="text" class="input-medium" name="articleAuthor" value="${vo.articleAuthor }" />
										...
										<div class="control-group">											
											...
											<div class="controls">
												<textarea class="form-control" id="editor_id" name="articleContent" style="width:500px;height:300px;">${vo.articleContent }</textarea>
										...
										<div class="control-group">											
											...
											<div class="controls">
												<input type="text" class="input-medium" name="articleDate" value="${vo.articleDate }" />
