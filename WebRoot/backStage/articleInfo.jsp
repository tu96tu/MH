		...
		<div class="row">
			...
			<div class="span9">
				...
				<div class="plan-features">
						<form method="post" action="article-search" id="edit-profile" class="form-horizontal">
							<fieldset>
								<div class="control-group">											
									<div class="controls">
										<input type="text" class="input-medium" name="articleMessage" value="" placeholder="根据文章标题或者作者进行模糊搜索" style="width:500px"/>
										<button type="submit" class="btn btn-primary">搜索</button> 
										<button  class="btn "><a href="backStage/article-add.jsp" style="text-decoration: none">添加文章</a></button> 
									</div> <!-- /controls -->				
								</div> <!-- /control-group -->
							</fieldset>
						</form>
				...
				<div class="widget widget-table">
						...
						<table class="table table-striped table-bordered">
							...
							<tbody>
								...
								<tr>
									...
									<td>${vo.articleAuthor }</td>
									<td>${vo.articleContent }</td>
									<td>${vo.articleDate }</td>
									<td class="action-td">
									<c:if test="${vo.articlePic==null }">空</c:if>
									<c:if test="${vo.articlePic!=null }"><img src="${vo.articlePic }" style="width:120px;height:120px"></c:if>
									</td>
									<td><a href="article-modify1?articleNo=${vo.articleNo }" class="btn btn-success btn-xs"><i class="glyphicon glyphicon-tags" ></i> 修改</a>
										<a onclick="return confirm('您确定要删除该文章信息吗？')" class="btn btn-danger btn-xs" href="article-delete?articleNo=${vo.articleNo }"><i class="glyphicon glyphicon-remove"></i> 删除</a>    </td>
								</tr>
								</c:forEach>
					...
					<div class="text-center" center>
							<etc:page url="article-list?page={page}" page="${pageVO }"/>
					</div>
