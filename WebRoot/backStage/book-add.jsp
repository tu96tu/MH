				...
				<div class="row">
					...
					<div class="span9">
						...
						<ul class="nav nav-tabs">
						  <li class="active">
						  	<a href="#2" data-toggle="tab">添加书籍</a>
						  </li>
						</ul>
						...
						<br />
							...
							<div class="tab-content">	
								<div class="tab-pane active" id="2">
									<form method="post" action="book-add" id="edit-profile" class="form-horizontal" enctype="multipart/form-data">
									<fieldset>
										
										<div class="control-group">											
											<label class="control-label" for="bookName">书籍名称</label>
											<div class="controls">
												<input type="text" class="input-medium" name="bookName" value="" />
										...
										<div class="control-group">											
											...
											<div class="controls">
												<input type="text" class="input-medium" name="bookAuthor" value="" />
										...
										<div class="control-group">											
											...
											<div class="controls">
												<input type="text" class="input-medium" name="bookAge1" value="" />
										...
										<div class="control-group">											
											...
											<div class="controls">
												<input type="text" class="input-medium" name="bookAge2" value="" />
										...
										<div class="control-group">											
											...
											<div class="controls">
												<textarea class="form-control" name="bookIntrd" rows="3" ></textarea>
										...
										<div class="control-group">											
											...
											<div class="controls">
												<textarea class="form-control" name="bookGrade" rows="3" ></textarea>
