				...
				<div class="row">
					...
					<div class="span9">
						...
						<ul class="nav nav-tabs">
						  <li class="active">
						  	<a href="#2" data-toggle="tab">修改试题信息</a>
						  </li>
						</ul>
						...
						<br />
							...
							<div class="tab-content">	
								<div class="tab-pane active" id="2">
									<form method="post" action="question-modify2" id="edit-profile" class="form-horizontal" />
									<fieldset>
										
										<div class="control-group">											
											<label class="control-label" for="quTitle">试题题目</label>
											<div class="controls">
												<input type="text" class="input-medium" name="quTitle" value="${vo.quTitle }" />
										...
										<div class="control-group">											
											...
											<div class="controls">
												<textarea class="form-control" name="quOption1" rows="3" >${vo.quOption1 }</textarea>
										...
										<div class="control-group">											
											...
											<div class="controls">
												<textarea class="form-control" name="quOption2" rows="3" >${vo.quOption2 }</textarea>
										...
										<div class="control-group">											
											...
											<div class="controls">
												<textarea class="form-control" name="quOption3" rows="3" >${vo.quOption3 }</textarea>
											...
											<div class="controls">
												<textarea class="form-control" name="quOption4" rows="3" >${vo.quOption4 }</textarea>
										...
										<div class="control-group">											
											...
											<div class="controls">
												<input type="text" class="input-medium" name="quOption1Score" value="${vo.quOption1Score }" />
										...
										<div class="control-group">											
											...
											<div class="controls">
												<input type="text" class="input-medium" name="quOption2Score" value="${vo.quOption2Score }" />
										...
										<div class="control-group">											
											...
											<div class="controls">
												<input type="text" class="input-medium" name="quOption3Score" value="${vo.quOption3Score }" />
										...
										<div class="control-group">											
											...
											<div class="controls">
												<input type="text" class="input-medium" name="quOption4Score" value="${vo.quOption4Score }" />
										...
										<div class="form-actions">
											...
											<button class="btn"><a href="question-list.action">返回</a></button>
										</div> <!-- /form-actions -->
									</fieldset>
								</form>
								</div>
